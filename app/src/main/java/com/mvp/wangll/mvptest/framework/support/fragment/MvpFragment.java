...
public class MvpFragment<V extends MvpView,P extends MvpPresenter<V>> extends Fragment implements FragmentMvpDelegate,MvpDelegate<V,P>,LoaderManager.LoaderCallbacks<P> {
